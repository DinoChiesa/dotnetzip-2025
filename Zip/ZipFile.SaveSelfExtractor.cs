...
namespace Ionic.Zip
{
    ...
    partial class ZipFile
    {
        ...
        private static void ExtractResourceToFile(System.Reflection.Assembly a, string resourceName, string filename)
        {
            int n = 0;
        ...
        private void _SaveSfxStub(string exeToGenerate, SelfExtractorSaveOptions options)
        {
            ...
            try
            {
                ...
                using (var csharp = new Microsoft.CSharp.CSharpCodeProvider
                    ...
                    var a2 = System.Reflection.Assembly.GetExecutingAssembly();
