...
//
// last saved (in emacs):
// Time-stamp: <2025-January-18 19:08:19>
//
// ------------------------------------------------------------------
//
...
namespace Ionic.Zip
{
    ...
    internal class WinZipAesCrypto
    {
        ...
        private int Rfc2898KeygenIterations = 1000;  // defined by the spec. No longer considered to be secure.
        ...
        public static WinZipAesCrypto ReadFromStream(string password, int KeyStrengthInBits, Stream s)
        {
            ...
            s.ReadExactly(c._Salt, 0, c._Salt.Length);
            s.ReadExactly(c._providedPv, 0, c._providedPv.Length);
        ...
        private void _GenerateCryptoBytes()
        {
            ...
            System.Security.Cryptography.Rfc2898DeriveBytes rfc2898 =
                new System.Security.Cryptography.Rfc2898DeriveBytes(_Password, Salt, Rfc2898KeygenIterations, HashAlgorithmName.SHA1);
        ...
        public void ReadAndVerifyMac(System.IO.Stream s)
        {
            ...
            s.ReadExactly(_StoredMac, 0, _StoredMac.Length);
